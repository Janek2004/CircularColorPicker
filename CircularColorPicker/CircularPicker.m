...
- (void)drawRect:(CGRect)rect
{
    ...
    // I need to create a path and add to it lines and etc.
    //CGContextSetStrokeColorWithColor(context, [[UIColor blueColor]CGColor]);
    //create paths
    
//    redPart= CGPathCreateMutable();
//    greenPart = CGPathCreateMutable();
//    bluePart = CGPathCreateMutable();
//    yellowPart = CGPathCreateMutable();
//    
//    blackPart = CGPathCreateMutable();
//    grayPart = CGPathCreateMutable();
//    whitePart = CGPathCreateMutable();
//    orangePart = CGPathCreateMutable();
